  ...
  return (
    ...
    <div className='container relative'ref={parallaxRef}>
     ...
     text-center mb-[3.875rem] md:mb-20 lg:mb[6.25rem]'>
        <h1 className='h1 mb-6'>Explore the World 
        possibilities of&nbsp;AI&nbsp; chatting with {``}
         <span className='inline-block relative'>Brainwave 
         <img src={curve} className='absolute top-full
         left-0 w-full xl:mt-2 width={624} height={28} width={264} height={28}' alt='curve' />
          </span>
         </h1>
         <p className='body-1 max-w-3-xl mx-auto mb-6
          text-n-2'>
            unleash the power of AI within the brainwave.
            upgrade your creativity with {''}.
